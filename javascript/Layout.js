...
var layout = {
	...
	display: function (success)
	{
		...
		// Corpus helper
		if (gq.quran.isSelected('quran-corpus'))
		{
			$('.corpusQuickHelp').removeClass('hide');
			
			// if (!$.browser.mozilla)
			// 	this.message('error', 'Tajweed fonts best displayed in <a href="http://FireFox.com">FireFox</a> browser.');
		}
		else if (!$('.corpusQuickHelp').hasClass('hide'))
		{
			$('.corpusQuickHelp').addClass('hide');
		}
	...
	bindExtra: function ()
	{
		...
		//$('.tips, .tipsWord').live('click', UI_Tooltip_Handler);
